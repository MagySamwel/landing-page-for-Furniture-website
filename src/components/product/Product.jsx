...
function Product() {
    return (
        <Grid2 container className='product-section bg-light' spacing={1}>
            <Grid2 size={3}>
            ...
            <Grid2 size={3} className="product-img" role='button'>
                <img src="https://themewagon.github.io/furni/images/product-1.png" alt="" width={'300px'} />
            ...
            <Grid2 size={3} className="product-img" role='button'>
                <img src="https://themewagon.github.io/furni/images/product-2.png" alt="" width={'300px'} />
            ...
            <Grid2 size={3} className="product-img" role='button'>
                <img src="https://themewagon.github.io/furni/images/product-3.png" alt="" width={'300px'} />
